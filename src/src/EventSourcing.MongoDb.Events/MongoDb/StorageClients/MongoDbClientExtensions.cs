...
static class MongoDBClientExtensions
{
	...
	public static async IAsyncEnumerable<T> QueryEnumerableAsync<T>(
	...
	public static IAsyncEnumerable<T> QueryEnumerableAsync<T>(
		this MongoDBClient mongoDbClient,
		Expression<Func<T, bool>> whereClause,
		int maxRecordsPerOperation = ContinuationRequest.DefaultMaxRecords,
	...
	public static IAsyncEnumerable<T> QueryEnumerableAsync<T, TOrderBy>(
		this MongoDBClient mongoDbClient,
		Expression<Func<T, bool>> whereClause,
		...
		where T : class =>
		mongoDbClient.QueryEnumerableAsync(
			whereClause,
	...
	public static async IAsyncEnumerable<T> ListEnumerableAsync<T>(
		this MongoDBClient mongoDbClient,
		Func<IQueryable<T>, IQueryable<T>>? orderByClause,
		int maxRecordsPerOperation = ContinuationRequest.DefaultMaxRecords,
		[EnumeratorCancellation] CancellationToken cancellationToken = default
	...
	public static IAsyncEnumerable<T> ListEnumerableAsync<T>(
		this MongoDBClient mongoDbClient,
		int maxRecordsPerOperation = ContinuationRequest.DefaultMaxRecords,
		CancellationToken cancellationToken = default
	)
		where T : class => mongoDbClient.ListEnumerableAsync<T>(null, maxRecordsPerOperation, cancellationToken);

	public static IAsyncEnumerable<T> ListEnumerableAsync<T, TOrderBy>(
		this MongoDBClient mongoDbClient,
		Expression<Func<T, TOrderBy>> orderByAscending,
		int maxRecordsPerOperation = ContinuationRequest.DefaultMaxRecords,
		CancellationToken cancellationToken = default
		...
		where T : class =>
		mongoDbClient.ListEnumerableAsync<T>(
			m => m.OrderBy(orderByAscending),
			maxRecordsPerOperation,
			cancellationToken
		);
