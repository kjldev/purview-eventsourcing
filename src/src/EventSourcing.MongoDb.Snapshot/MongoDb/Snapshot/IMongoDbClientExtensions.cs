...
static class IMongoDBClientExtensions
{
	...
	public static IAsyncEnumerable<T> GetQueryEnumerableAsync<T, TOrderBy>(
		...
		where T : class =>
		mongoDbClient.GetQueryEnumerableAsync(
			whereClause,
	...
	public static IAsyncEnumerable<T> GetListEnumerableAsync<T>(
		...
		where T : class => mongoDbClient.GetListEnumerableAsync<T>(null, maxRecordsPerOperation, cancellationToken);
	...
	public static IAsyncEnumerable<T> GetListEnumerableAsync<T, TOrderBy>(
		...
		where T : class =>
		mongoDbClient.GetListEnumerableAsync<T>(
			m => m.OrderBy(orderByAscending),
			maxRecordsPerOperation,
			cancellationToken
		);
