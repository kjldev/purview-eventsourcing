...
static class CodeGenHelpers
{
	...
	static readonly Lazy<string[]> GenAttributes = new(() =>
		[EmbeddedConstant, ExcludeFromCodeCoverageConstant, ConditionalAttribute.Value, GeneratedCodeAttribute.Value]
	);
	...
	public static string GetGeneratedCodeAttribute(int tabs = 1) =>
